  ...
  return (
    <div className="rounded-2xl bg-subway-card p-6 shadow-xl max-w-md mx-auto">
      ...
      <form onSubmit={(e) => {
        ...
        {/* Destination */}
        <div>
          <label htmlFor="destination" className="block text-sm font-medium text-subway-text mb-2">
            Destination
          </label>
          <input
            type="text"
            ...
            className="w-full px-4 py-3 rounded-lg bg-subway-surface border border-subway-muted text-subway-text placeholder-subway-muted focus:border-subway-a focus:outline-none transition-colors"
            required
          />
        </div>
        ...
        <p className="text-xs text-subway-muted text-center">
          Weather data available for dates between May 3 - August 19, 2025
        </p>

        {/* Temperature Tolerance */}
        <div>
          <label className="block text-sm font-medium text-subway-text mb-3">
            Temperature Tolerance
          </label>
              ...
              <label key={option.value} className="flex items-center space-x-3 cursor-pointer">
                ...
                <div className={`flex items-center space-x-3 p-3 rounded-lg border transition-colors cursor-pointer ${
                  selectedTolerance === option.value 
                    ...
                    : 'border-subway-muted hover:border-subway-a'
                }`}>
                  ...
                  <span className="text-subway-text font-medium">{option.label}</span>
                </div>
              </label>
            ))}
          </div>
